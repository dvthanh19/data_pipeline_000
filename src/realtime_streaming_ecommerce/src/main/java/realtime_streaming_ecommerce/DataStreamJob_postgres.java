...
public class DataStreamJob_postgres
{
    private static final String db_addr = "localhost:5432";
    private static final String db_name = "mydb";
    private static final String jdbcUrl = "jdbc:postgresql://" + db_addr + "/" + db_name;
    ...
    {
        System.out.println("[Postgres] Starting...");
        ...
        KafkaSource<Transaction> source = KafkaSource.<Transaction>builder()
                ...
                .setTopics(topic)
                .setGroupId("flink-postgres-consumer")
